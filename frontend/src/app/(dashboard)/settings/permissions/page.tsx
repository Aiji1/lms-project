...
export default function PermissionsPage() {
  ...
  useEffect(() => {
    const fetchOverridesForRole = async () => {
      try {
        ...
        const res = await api.get('/permission-overrides', { params: { target_type: 'role', target_id: selectedRole } });
  ...
  async function handleSave() {
    ...
    try {
      ...
      const freshOverridesRes = await api.get('/permission-overrides', { 
        params: { target_type: 'role', target_id: selectedRole } 
      });
